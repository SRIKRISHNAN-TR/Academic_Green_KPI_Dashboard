...
import { IconUser, IconBell, IconPalette, IconShieldCheck } from "@tabler/icons-react";
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                      ...
                      <p className="text-sm text-muted-foreground">
                        Receive email updates about sustainability alerts
                      </p>
                    </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                      ...
                      <p className="text-sm text-muted-foreground">
                        Get weekly summary of KPI performance
                      </p>
                    </div>
                    <Switch defaultChecked />
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                      ...
                      <p className="text-sm text-muted-foreground">
                        Notify when KPIs approach or exceed targets
                      </p>
                    </div>
                    <Switch defaultChecked />
                  </div>
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                      ...
                      <p className="text-sm text-muted-foreground">
                        Use a more compact layout for tables and cards
                      </p>
                    </div>
                    <Switch />
                  </div>
